...
class Product(models.Model):
    ...
    p_offer=models.FloatField(blank=True,default=False)                                
    cat_offer=models.FloatField(blank=True, default=False)
    user_price=models.FloatField(blank=True, default=False)
